...
if [ "$1" = "openshift" ];then
  ...
  [ "$OPP_MIRROR_LATEST_TAG" != "${OPP_INDEX_IMAGE_TAG}" ] && OPP_EXEC_USER_SECRETS="$OPP_EXEC_USER_SECRETS -e mirror_index_images=\"$OPP_MIRROR_INDEX_IMAGE:${OPP_INDEX_IMAGE_TAG}|$OPP_REGISTRY_MIRROR_USER|$REGISTRY_MIRROR_PW|$OPP_MIRROR_INDEX_MULTIARCH_POSTFIX\""
  [ "$OPP_MIRROR_LATEST_TAG" == "${OPP_INDEX_IMAGE_TAG}" ] && OPP_EXEC_USER_SECRETS="$OPP_EXEC_USER_SECRETS -e mirror_index_images=\"$OPP_MIRROR_INDEX_IMAGE:${OPP_INDEX_IMAGE_TAG}|$OPP_REGISTRY_MIRROR_USER|$REGISTRY_MIRROR_PW|$OPP_MIRROR_INDEX_MULTIARCH_POSTFIX|$OPP_MIRROR_INDEX_IMAGE:latest\""
