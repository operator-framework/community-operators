...
IIB_OUTPUT_REGISTRY_USER=${IIB_OUTPUT_REGISTRY_USER-"$OPP_REGISTRY_MIRROR_INDEX_API_USERNAME"}
IIB_OUTPUT_REGISTRY_TOKEN=${IIB_OUTPUT_REGISTRY_TOKEN-"$OPP_MIRROR_INDEX_REGISTRY_API_TOKEN"}
...
function ExecParameters() {
    ...
    if [ "$OPP_CLUSTER_TYPE" = "openshift" ] && [[ $1 == orange_* ]] && [[ $OPP_PROD -eq 1 ]];then
        if [[ $OPP_MIRROR_INDEX_ENABLED -eq 1 ]];then
            ...
            [ "$OPP_MIRROR_LATEST_TAG" != "${1/orange_/}" ]&& OPP_EXEC_USER_SECRETS="$OPP_EXEC_USER_SECRETS -e mirror_index_images=\"$OPP_MIRROR_INDEX_REGISTRY/$OPP_MIRROR_INDEX_ORGANIZATION/$OPP_MIRROR_INDEX_NAME:${1/orange_/}|$OPP_REGISTRY_MIRROR_INDEX_API_USERNAME|$OPP_MIRROR_INDEX_REGISTRY_API_TOKEN|$OPP_MIRROR_INDEX_MULTIARCH_POSTFIX\""
            [ "$OPP_MIRROR_LATEST_TAG" = "${1/orange_/}" ] && OPP_EXEC_USER_SECRETS="$OPP_EXEC_USER_SECRETS -e mirror_index_images=\"$OPP_MIRROR_INDEX_REGISTRY/$OPP_MIRROR_INDEX_ORGANIZATION/$OPP_MIRROR_INDEX_NAME:${1/orange_/}|$OPP_REGISTRY_MIRROR_INDEX_API_USERNAME|$OPP_MIRROR_INDEX_REGISTRY_API_TOKEN|$OPP_MIRROR_INDEX_MULTIARCH_POSTFIX|$OPP_MIRROR_INDEX_REGISTRY/$OPP_MIRROR_INDEX_ORGANIZATION/$OPP_MIRROR_INDEX_NAME:latest\""
        else
