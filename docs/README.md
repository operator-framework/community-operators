...
Similarly, to update your operator you need to submit a PR with any changes to your Operator resources. Refere to our [contribution guide](./operator-versioning.md) for more details.
